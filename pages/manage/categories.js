...
const ICON_OPTIONS = [
  ...
  { value: "frozen-food", label: "Frozen Food", icon: faSnowflake },
  { value: "grill-chill", label: "Grill and Chill", icon: faFireFlameCurved },
  ...
  { value: "drinks", label: "Drinks", icon: faMugHot },
  { value: "water-beverages", label: "Water & Beverages", icon: faGlassWater },
  { value: "stationeries", label: "Stationeries", icon: faPenRuler },
  { value: "personal-care", label: "Personal Care", icon: faHeartPulse },
  { value: "pantry-dry-ingredient", label: "Pantry & Dry Ingredient", icon: faWheatAwn },
  { value: "home-kitchen", label: "Home & Kitchen", icon: faHouse },
  { value: "health-beauty", label: "Health & Beauty", icon: faHeartPulse },
  { value: "formula-feeding", label: "Formula & Feeding", icon: faBabyCarriage },
  { value: "cosmetics-beauty", label: "Cosmetics & Beauty", icon: faPalette },
  { value: "cleaning-laundry", label: "Cleaning & Laundry", icon: faSprayCanSparkles },
  { value: "canine-care-food", label: "Canine Care & Food", icon: faDog },
  { value: "breakfast-cereals", label: "Breakfast & Cereals", icon: faBowlFood },
  { value: "biscuits-confectioneries", label: "Biscuits & Confectionaries", icon: faCookieBite },
  { value: "bakery", label: "Bakery", icon: faBreadSlice },
  { value: "baby-wipes-diaper", label: "Baby Wipes & Diaper", icon: faBaby },
  { value: "baby-health-care", label: "Baby Health & Care", icon: faHeartPulse },
];
