/**
 * AI Orchestrator â€” Shared Pipeline
 * 
 * Every AI module follows the same workflow:
 * 1. Generate metrics â†’ 2. Hash â†’ 3. Check cache â†’ 4. Call Gemini if needed â†’ 5. Store â†’ 6. Return
 * 
 ...
 * @param {Function} params.generateAI - async function(metrics) â†’ { success, data, meta }
 * @param {Function} params.formatResult - function(aiData, metrics) â†’ recommendation fields
