...
Return JSON:
{
  ...
  "immediateActions": [{"action": "string", "products": ["name"], "reason": "string", "impact": "₦ amount", "urgency": "critical|high|medium"}],
  ...
  "stopPurchasing": [{"product": "name", "reason": "string", "tiedUpValue": "₦ amount"}],
  "bundleSuggestions": [{"products": ["name1", "name2"], "reason": "string"}],
  "risks": [{"risk": "string", "severity": "high|medium|low", "mitigation": "string"}],
  "opportunities": [{"opportunity": "string", "potentialBenefit": "₦ amount"}],
  "healthScore": 0-100,
  "confidence": 0-100,
