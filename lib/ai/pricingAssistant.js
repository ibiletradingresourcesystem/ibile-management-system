...
- currentMargin is (price - cost) / price, the share of the selling price that is profit.
  currentMarkup is that same profit read against cost, (price - cost) / cost, and reads higher.
