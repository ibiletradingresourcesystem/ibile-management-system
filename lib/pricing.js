 ...
 * than on top of it. profitAmount is the whole gap between cost and the sale price; vatAmount is
 * the slice of the sale price that is VAT, shown so it is visible but never taken off the profit.
 */
